...
set_property PACKAGE_PIN V2 [get_ports {display[0]}]
set_property PACKAGE_PIN T3 [get_ports {display[1]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {a b display enable segments overflow}]
